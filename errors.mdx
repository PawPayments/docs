...
| 400 | `SANDBOX_UNSUPPORTED` | Endpoint is live-only; called with a sandbox key. See [Sandbox](/sandbox). |
| 400 | `SANDBOX_ONLY` | Endpoint is sandbox-only (e.g. simulating a payment); called with a live key. |
